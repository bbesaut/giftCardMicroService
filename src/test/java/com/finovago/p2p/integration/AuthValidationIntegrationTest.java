...
@Transactional
class AuthValidationIntegrationTest extends AbstractIntegrationTest {
    ...
    void setUp() {
        ...
        // are non-transactional and commit rows that outlive this class, so clear both before deleting merchants.
