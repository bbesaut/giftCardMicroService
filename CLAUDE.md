...
- JPA with Lombok
- Swagger/OpenAPI
- Mail (password reset): `spring-boot-starter-mail` / `JavaMailSender`, Gmail SMTP in dev/prod, MailHog (Testcontainers) in tests
